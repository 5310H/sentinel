...
#else
    /* Linux Build - Define ESP-IDF types */
 ...
 * - MAC address
 * - Interrupt GPIO (GPIO43)
 * - PHY reset GPIO (GPIO44)
 * 
...
/**
 * @brief Perform health check on W5500 ethernet chip
 * 
 * Verifies W5500 is responding and has valid MAC address.
 * Should be called after init_ethernet_v3() to confirm functionality.
 * 
 * @return ESP_OK if health check passes, ESP_FAIL otherwise
 */
